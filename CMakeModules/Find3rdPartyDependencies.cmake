...
IF(USE_3RDPARTY_BIN)
    ...
    SET(TEST_3RDPARTY_DIR "${PARENT_DIR}/3rdparty")#设置其他查找库的位置
    SET(OTHER_3RDPARTY_DIR "${PARENT_DIR}/sdk")#设置其他查找库的位置
...
set(FFMPEG_ROOT ${ACTUAL_3RDPARTY_DIR})
message(STATUS "3rdParty-Package设置文件目录:---${ACTUAL_3RDPARTY_DIR}" ) 
SET(ENV{SDL2DIR} ${ACTUAL_3RDPARTY_DIR})
SET(ENV{GEOS_DIR} ${ACTUAL_3RDPARTY_DIR})

SET(ENV{OPENTHREADS_DIR} ${OTHER_3RDPARTY_DIR}/osg)
SET(ENV{OSG_DIR} ${OTHER_3RDPARTY_DIR}/osg)
SET(ENV{SILVERLINING_DIR} ${OTHER_3RDPARTY_DIR}/effect)#设置其他查找库的位置
SET(ENV{TRITON_DIR} ${OTHER_3RDPARTY_DIR}/effect)#设置其他查找库的位置
#SET(ENV{CMAKE_PREFIX_PATH} "C:/Qt/Qt5.8.0/5.8/msvc2015_64/lib/cmake")#设置其他查找库的位置

#SET(ENV{GEOS_INCLUDE_DIR} ${ACTUAL_3RDPARTY_DIR}/include)
